...
Protected Module OSVersionInformation
		...
		Private Sub Initialize()
		  ...
		  dim szCSDVersion,s as string
		    ...
		    if mplatformId = 2 then 'NT
		      ...
		      elseif mmajorVersion = 6 then
		        mIsNT6 = true
		        if mminorVersion = 0 then 'Vista
		          if mproducttype <> 3 then
		            mOSName = "Windows Vista"
		            mIsVista = true
		          else
		            mOSName = "Windows Server 2008"
		            mIs2008 = true
		          end if
		          mbuildstring = str(mbuild)
		        elseif mminorVersion = 1 then '7
		          if mproducttype <> 3 then
		            mOSName = "Windows 7"
		            mIs7 = true
		          else
		            mOSName = "Windows Server 2008 R2"
		            mIs2008 = true
		          end if
		          mbuildstring = str(mbuild)
		        end if
	...
	#tag Method, Flags = &h1
		Protected Function Is2008() As Boolean
		  Initialize
	...
	#tag Method, Flags = &h1
		Protected Function Is7() As Boolean
		  Initialize
